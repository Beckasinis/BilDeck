...
export default function ScienceSection() {
  return (
    <section className="science-section">
      <h2>Varför <Wordmark /> fungerar</h2>
      ...
      <div className="science-block science-block--reverse">
        <div className="science-text">
          ...
          <p>Glömskan sker snabbast i början och planar sedan gradvis ut.</p>
          <p>
          ...
          <p>
            <Wordmark /> bygger på samma princip: kort du missar repeteras oftare än
            kort du redan kan.
          </p>
        </div>
